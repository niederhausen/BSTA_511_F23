---
title: "DRAFT: Day 10 Part 1: <br> Hypothesis testing for <br> mean from one-sample <br> (Sections 4.3, 5.1)"
...
See file [Projects in RStudio](../resources/Projects_in_R.qmd) for more information.
...
* Figure out where the test statistic's value is in relation to the values in the columns, i.e. between which columns is the test statistic?

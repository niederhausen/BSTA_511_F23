...
format: 
  revealjs:
      ...
      chalkboard: true
      theme: sky
      width:  1600 # 1050 #default 1050; ipad 3:4, 1600
      height: 1200 #800 #default 700; 788 for 3:4, 1200
      slide-number: true
execute:
  echo: true
# editor: visual
...
* __R packages__ -> __<font color="darkorange">install for next class!!!</font>__
...
* __<font color="green">How many observations are in this dataset?</font>__

* __<font color="green">What are the variable types in this dataset?</font>__
...
_<font color="purple">Can the iris species be determined by these variables?</font>_
...
* Type the following command in the console window
  - _Warning: this command cannot be knitted. It will give an error._ 
```{r}
#| eval: false
...
J Barton et al.  
Arthritis Care & Research. 2021 Sep 27
...
__<font color="darkorange">Sample mean</font>__: the average value of observations
...
::: columns
::: {.column width="50%"}
* The __<font color="darkorange">median</font>__ is the middle value of the observations in a sample.  
...
__<font color="darkorange">mode</font>__: the most frequent value in a dataset
...
__standard deviation__ is (approximately) the distance between a typical observation and the mean 
...
![[https://statistics-made-easy.com/empirical-rule/](https://statistics-made-easy.com/empirical-rule/)](/img_slides/empirical-rule.png){fig-align="center"}
...
The __<font color="darkorange">interquartile range (IQR)</font>__ is the distance between the third and first quartiles.
$$IQR = Q_3 - Q_1$$
...
__<font color="darkorange">5 number summary</font>__
```{r}
...
Summary statistics are called __<font color="darkorange">robust estimates</font>__ if extreme observations have little effect on their values
...
![](/img_slides/tidyverse_celestial.png){fig-align="center"}
...
* Danielle Navarro’s YouTube video on __*Installing and loading R packages*__: https://www.youtube.com/watch?v=kpHZVyDvEhQ
...
## Install the pacakges listed below <span style="color:darkorange">before Day 3</span>
...
* `skimr`
  - for skimming and getting a summary of a dataset
* `janitor`
...
![[Gapminder Dollarstreet](https://www.gapminder.org/dollar-street?topic=get-water)](/img_slides/gapminder_dollarstreet_getwater.png){fig-align="center"}

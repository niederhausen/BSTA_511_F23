...
* _k_ groups
* _n_ observations in each of the _k_ groups
...
| *j* = $n_i$ | $x_{1n_i}$      | $x_{2n_i}$      | $x_{3n_i}$      | $\ldots$ | $x_{kn_i}$      |           |
...
* $H_0:$ variances of group levels are equal
* $H_A:$ variances of group levels are NOT equal

...
* (b): In addition to calculating the CI using the formula, create a dataset in R and compute the CI using the appropriate R statistical test. 
...
* (b): In addition to calculating the hypothesis test using the formula, create a dataset in R and run the test using the appropriate R statistical test. 

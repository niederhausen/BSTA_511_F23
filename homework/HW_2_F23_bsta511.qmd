...
*Part (b) asks you to create a Venn Diagram. You do not need to turn this part in. If you want an R challenge though, you can use the `VennDiagram` or other package to create one. See https://www.geeksforgeeks.org/how-to-create-a-venn-diagram-in-r/ for some examples.* 
...
__<font color="darkorange">IMPORTANT R tip</font>__
...
## Use the `mutate()` command explained on Slide 23 of the Day 4 notes to create a new column (variable) in the NHANES dataset for the heights in inches. Then find the mean and standard deviation of the heights in inches. Note that 1 centimeter is approximately 0.3937 inches.

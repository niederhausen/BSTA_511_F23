---
title: "Day 4 code: Data wrangling"
author: "Meike Niederhausen"
date: "BSTA 511/611 Fall 2022"
output:
  html_document:
    number_sections: yes
    toc: yes
...
# MoRitz's tip of the day: code chunks

Want to get rid of those messages and warnings in your knitted RMarkdown files?  
Check out https://rmarkdown.rstudio.com/lesson-3.html.

You can set your code chunk preferences 
  * for each chunk individually, 
  * or globally in the setup chunk containing `knitr::opts_chunk$set(echo = TRUE)`

* Examples
  * `echo = TRUE`  
      * always keep as TRUE in this class
  * `message = FALSE` 
  * `warning = FALSE` 
